 ...
 * @version    $Id: Directories.php 99 2009-03-16 18:32:15Z jaachan $
 */
//----------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------
/**
 * Class that filters a list so it only returns directories
 *
 * @category   JAdVA
 * @package    Jadva_File
 * @subpackage Jadva_File_Filter
 ...
 * @license    http://www.JaAchan.com/software/LICENSE.txt
 */
class Jadva_File_Filter_Directories implements Jadva_File_Filter_Interface
{
	//------------------------------------------------
